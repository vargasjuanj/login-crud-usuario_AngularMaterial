...
export class TablaDataSource extends DataSource<Usuario> {
  ...
  /**
   * Paginate the data (client-susuarioe). If you're using server-susuarioe pagination,
  ...
  /**
   * Sort the data (client-susuarioe). If you're using server-susuarioe sorting,
   * this would be replaced by requesting the appropriate data from the server.
   */
...
/** Simple sort comparator for example usuario/nombre columns (for client-susuarioe sorting). */
